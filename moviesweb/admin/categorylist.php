...
<div class="container">
  ...
  <a class="navbar-brand" href="#">Category On MoviesWeb</a>
  ...
  <tbody>
    <tr>
      ...
      <td>
       ...
       <a class="btn btn-outline-secondary" href="editcategory.php?id=<?php echo $row['id']; ?>&forkey=<?php echo$row['category_id']; ?>&catname=<?php echo$row['category_name']; ?>">Edit</a>
      </td>
      </tr>
      <?php 
      $id = $row['id'];
